...
export const SHORTCUTS: ShortcutCategory[] = [
  { category: "Navigation", items: [
    ...
    { id: "nav.goNewsletters", keys: "g then n", desc: "Go to Newsletters / Notifications" },
    ...
    { id: "nav.goAllMail", keys: "g then m", desc: "Go to All Mail" },
  ...
  { category: "Actions", items: [
    ...
    { id: "action.categorize", keys: "l", desc: "Categorize" },
